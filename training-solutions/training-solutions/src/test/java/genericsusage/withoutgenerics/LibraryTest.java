...
class LibraryTest {
    ...
    @Test
    void getFirstBookTestInvalid() {
        books = new ArrayList(List.of("book", bookA, bookB));
        exception = assertThrows(IllegalStateException.class, () -> library.getFirstBook(books));
        assertEquals("First element is not a book.", exception.getMessage());
